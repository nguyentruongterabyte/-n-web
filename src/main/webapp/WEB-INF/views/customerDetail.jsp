...
<link rel="icon" type="image/x-icon"
	href="${pageContext.servletContext.contextPath}/resource/images/favicon/icons8-customer-16.png">
...
<body>
	...
	<div class="w3-top">
		<div class="w3-white w3-xlarge"
			...
			<div class="w3-center w3-padding-16">Thông tin khách hàng</div>
		</div>
	</div>
	<div class="container">
		...
		<div class="row row-no-padding">
			<div class="col-md-8 col-md-offset-2">
				<form:form
					action="${pageContext.servletContext.contextPath}/khach-hang/chinh-sua.htm?id=${customer.id}"
					...
					<div class="row mt-16">
						<div class="col-md-4">
							<div class="row">
								...
								<div class="col-md-6">
									<input value="${customer.id}" class="form-control"
										readonly="readonly" />
								</div>
							</div>
						</div>
					...
					<div class="row mt-16">
						...
						<div class="col-md-8">
							<form:textarea path="address" cols="40" rows="3"
								class="form-control no-resize" readonly="true" />
						</div>
					</div>
					<div class="row mt-16">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<form:input path="identifyNumber" class="form-control"
										readonly="true" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<form:select path="groupOfCustomer.label" class="form-control"
										disabled="true">
					...
					<div class="row mt-16">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-8">
									<input value="${customer.birthday}" class="form-control"
										readonly="readonly" />
								</div>
							</div>
						</div>
